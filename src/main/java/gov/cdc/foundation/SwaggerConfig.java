...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("FDNS CDA Utilities Microservice")
				.description("This is the repository with the CDA utilities service to parse and generate sample CDA data.")
