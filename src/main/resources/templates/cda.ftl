...
<!-- edited with XMLSpy v2011 sp1 (http://www.altova.com) by Len Gallagher (NIST) -->
...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:sdtc="urn:hl7-org:sdtc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 http://xreg2.nist.gov:8080/hitspValidation/schema/cdar2c32/infrastructure/cda/C32_CDA.xsd">
	...
	<id root="2.16.840.1.113883.3.72" extension="MU_Rev3_HITSP_C32C83_4Sections_RobustEntries_NoErrors" assigningAuthorityName="NIST Healthcare Project"/>
	<!--The HL7/CCD specification requires that every CCD ClinicalDocument contain the  specific LOINC code 34133-9. Note that Meaningful Use defers to IHE specifications which do not require the CCD templateId on the document itself, thus allowing other codes to be used at this location. To avoid confusion it may be best to stick with this code as fixed in the absence of another required substitute.-->
	<code code="34133-9" displayName="Summarization of episode note" codeSystem="2.16.840.1.113883.6.1" codeSystemName="LOINC"/>
	<title>ONC Meaningful Use Example Document</title>
	<effectiveTime value="20101026130945"/>
	<confidentialityCode/>
	<languageCode code="en-US"/>
	<juridictionId value="${jurisdictionCode}" />
	<recordTarget>
		<patientRole>
...
None of the following address elements are specifically required by HITSP C32, so the address could be be just plain text at this location? Use of one or more of the following labeled address lines, with meaningful content, is recommended.
				...
				<streetAddressLine>Next Address line - if needed, etc.</streetAddressLine>
				<city>CityName</city>
				<state>StateName</state>
				<postalCode>ZipCode(5or9)</postalCode>
				<country>USA</country>
			</addr>
			<telecom/>
			<patient>
				...
				<administrativeGenderCode code="${sex}" displayName="${(sex == 'M')?then("Male","Female")}" codeSystem="2.16.840.1.113883.5.1" codeSystemName="HL7 AdministrativeGender"/>
				<birthTime value="${dob}"/>
				<!--HITSP/C83 requires patient marital status - if known, e.g. S, M, D-->
				<maritalStatusCode code="${maritalStatus}" displayName="${maritalStatusLabel}" codeSystem="2.16.840.1.113883.5.2" codeSystemName="HL7 Marital status"/>
	...
	<!--HITSP/C32 requires one or more support modules (i.e. participant) - if known; if not known, the participant element(s) may be removed in their entirety. However, many medical facilities require recording of the Next-of-Kin (NOK). The following shows how to represent that information in a participant element.-->
	...
	<!--The following documentationOf element is not required by HITSP/C32 or C83, but it is the place to provide a list of performers (e.g. medical providers such as nurses, physicians), with id's and contact information, if those performers are referenced in a <performer>/<assignedEntity>/<id> element elsewhere in this document, especially in the Problems section. The National Provider Identifier (NPI) is a 10-digit string issued by the Center for Medicare and Medicaide Services and is required by HIPPA in a number of healthcare interactions.-->
	<documentationOf typeCode="DOC">
		<serviceEvent classCode="PCPR">
			...
			<performer typeCode="PRF">
				...
				<assignedEntity>
					<id extension="Unknown" root="2.16.840.1.113883.4.6" assigningAuthorityName="NPI"/>
					<id extension="PseudoMD-2" root="2.16.840.1.113883.3.72.5.2" assigningAuthorityName="NIST Healthcare Testing Laboratory"/>
					<code code="200000000X" displayName="Allopathic and Osteopathic Physicians" codeSystemName="Provider Codes" codeSystem="2.16.840.1.113883.6.101"/>
					<addr/>
		...
		<!-- ******************************************************** Hospital 
			...
			<component>
				<section>
					...
					<code code="${reasonForStudyCode}" displayName="Hospital Discharge Diagnosis" codeSystem="2.16.840.1.113883.6.1" codeSystemName="LOINC" />
					<title>Hospital Discharge Diagnosis</title>
					<text>${reasonForStudyName}</text>
				</section>
			</component>
			<component>
				<!--Allergies-->
						...
						<substanceAdministration classCode="SBADM" moodCode="EVN">
							...
							<entryRelationship typeCode="SUBJ">
								...
								<act classCode="ACT" moodCode="INT">
									...
									<text>This is the text of the Patient Instruction.  Note that this instruction is printed in the narrative text of the parent Section and is refereced by the following pointer to it.<reference value="PntrtoSectionText"/>
									</text>
									<statusCode code="completed"/>
								</act>
							</entryRelationship>
							<entryRelationship typeCode="SUBJ">
								...
								<act classCode="ACT" moodCode="INT">
									...
									<text>This is the text of the Fulfillment Instruction.  Note that this instruction is printed in the narrative text of the parent Section and is refereced by the following pointer to it.<reference value="PntrtoSectionText"/>
									</text>
									<statusCode code="completed"/>
								</act>
							</entryRelationship>
					...
					<text>
						<table border="1" width="100%">
							...
							<tbody>
								...
								<tr ID="TESTSUMMARY_1">
									<td ID="TESTRANGE_1">HGB (M 13-18 g/dl; F 12-16 g/dl)</td>
									<td>13.2</td>
									<td>&#160;</td>
								</tr>
								<tr>
						...
						<organizer classCode="BATTERY" moodCode="EVN">
							...
							<component>
								<procedure classCode="PROC" moodCode="EVN">
									...
									<text>Extract blood for electrolytes tests. Not IHE rules require description and reference to go here rather than in originalText of code.<reference value="Ptr to text  in parent Section"/>
									</text>
									<statusCode code="completed"/>
									<effectiveTime value="200004061300"/>
									<performer>
